...
<body>
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Scooter/ola s1 images/Porcelain White.jpg" alt="TATA NEXON EV">
                    <div class="content">
    ...
    <section class="Specifications " id="Specifications">
        ...
        <div style="font-size: 1.2vw;">
            <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 85,000 onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
            ...
            <i class="fa-solid fa-gears"></i><strong> Motor </strong> :- IPM &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;
            <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 181 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 2.5 kWh &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <i class="fa-solid fa-suitcase-rolling"></i> <strong>Boot</strong> :- 34 litre &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <i class="fa-solid fa-car-side"></i> <strong> Max Speed</strong> :- 116 KMPH &nbsp;
        </div>
    </section>
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Ola S1 Air</td>
                    <td>₹ 85,000</td>
                    <td>Remote Start, Push Button Start, Digital Speedometer, Charging Point, Clock, Passenger Footrest, Anti theft Alarm</td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
                <tr>
                    <td>Ola S1 STD</td>
                    <td>₹ 1.04 Lakh</td>
                    <td>Remote Start, Push Button Start, Digital Speedometer, Charging Point, Clock, Passenger Footrest, Anti theft Alarm, Low Battery Indicator, Internet Connectivity</td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
                <tr>
                    <td>Ola S1 Pro</td>
                    <td>₹ 1.32 Lakh</td>
                    <td>Remote Start, Push Button Start, Digital Speedometer, Charging Point, Clock, Passenger Footrest, Anti theft Alarm, Low Battery Indicator, Internet Connectivity, Navigation, Mobile Application</td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
            </table>
        </div>
