...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cycles/Hero Lectro F3i/logo.jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F3i/front.png" alt="TATA NEXON EV">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F3i/lhs.png" alt="">
                    <div class="content">
                        <h3>Side View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F3i/back.png" alt="">
                    <div class="content">
                        <h3>Back View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F3i/rhs.png" alt="">
                    <div class="content">
                        <!--<h3>RHS View</h3>-->
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 40,999 &emsp;&emsp;&emsp;&emsp;
