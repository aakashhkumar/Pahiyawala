...
<head>
    ...
    <title>Techo Electra Emerge</title>
...
<body>
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Techo Electra Emerge/2.jpeg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Techo Electra Emerge/Yellow.jpg" alt="">
                    <div class="content">
    ...
    <section class="Specifications " id="Specifications">
        ...
        <div style="font-size: 1.2vw;">
            <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 68 Thousands onwards &emsp;&emsp;&emsp;&emsp;
            ...
            <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 70 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- 4-5 Hours &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
            <!-- <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 5 People <br> -->
            <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 1.8 kWh &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <i class="fa-solid fa-suitcase-rolling"></i> <strong>Boot</strong> :- 12 litre &emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <section class="Price_Variants" id="Price_Variants">
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Emerge Standard</td>
                    <td>₹ 68 Thousands</td>
                    <td>60-70 Km, 25 Kmph, 60 kg, 4-5 Hrs</td>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Techo Electra Emerge is an electric scooter available at a starting price of Rs. 68,286 in India. It is available in only 1 variant and 3 colours. Techo Electra Emerge generates 250 W power from its motor. With front disc and rear drum brakes,
            Techo Electra Emerge comes up with combined braking system of both wheels.
            <span id="dots">...</span><span id="more">
        <br>
        <br>
        The Emerge is an electric scooter from Pune-based start-up Techno Electra. The scooter has a curvy European design language that is further accentuated with the use of chrome bezel for the headlamp, LED turn indicators and LED DRLs. The scooter is available with the choice of three colour shades yellow, red and black.
        <br>
        <br>

        The Emerge uses a rigid tubular chassis and is powered by a 250 Watt BDLC motor that draws its power from a 48V 28Ah lithium-ion battery. The battery takes around 4-5 hours for a full charge following to which is claimed by the manufacturer to provide a range of 70-80 km. The Emerge is certified by ARAI and comes with several features like a centre locking system, LCD digital speedometer, and mobile charging USB port. It also comes with a forward-neutral-reverse switch.
        <br>
        <br>
        
        For cycle parts, the e-scooter is suspended by telescopic forks up front and dual shock absorbers for the rear. Braking is taken care by a disc brake at the front and a drum brake for the rear. The scooter rides on 10-inch tubeless tyres and has a ground clearance of 150mm. 
        </span>
        </p>
    ...
    <section style="text-align: center;" id="Brochure">
        <a href="https://static.autox.com/uploads/bikes/brochure/2021/07/techo-electra-emerge-brochure.pdf" class="btn" target="_blank">Click Here!! For Brochure</a>
    </section>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Techo Electra Emerge/Black.jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Techo Electra Emerge/Red.jpg" alt="Red">
                    <div class="content">
                        <h3>Red</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Techo Electra Emerge/Yellow.jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>
