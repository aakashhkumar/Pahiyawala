...
<body>
    ...
    <section class="home" id="home">
        ...
        <h3>Tata Tigor EV</h3>
        <img  src="../image/Cars/Tata Tigor EV/Tata Tigor EV.png" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Tigor EV/Tata Tigor EV.jpg" alt="Tata Tigor EV">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Tigor EV/Side View.png" alt="">
                    <div class="content">
                        <h3>Side View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Tigor EV/Rear View.jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Tigor EV/Interior.jpg" alt="Interior">
                    <div class="content">
                        <h3>Interior</h3>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Tigor EV//Automatic transmission.png" alt="Automatic transmission">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Tigor EV/" alt="">
                    <div class="content">
                        <h3> </h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 12.49  Lakh onwards &emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 306 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- 9.4 hours &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 5 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 26 kWh &nbsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-car-side"></i> <strong> Body Type</strong> :- 5 seater sedan &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <i class="fa-solid fa-suitcase-rolling"></i> <strong>Boot</strong> :- 316 litres
     </div>
    </section>
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Tigor EV XE</td>
                    <td>₹ 12.49 Lakh</td>
                    <td>26 kWh, Electric, Automatic, 306 km</td>
                </tr>
                <tr>
                    <td>Tigor EV XT</td>
                    <td>₹ 12.99 Lakh</td>
                    <td>26 kWh, Electric, Automatic, 306km</td>
                </tr>
                <tr>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Tata Tigor EV price starts at ₹ 12.49 Lakh and goes upto ₹ 13.75 Lakh (Avg. ex-showroom). Tigor EV comes in 4 variants. Tigor EV base model price in electric is ₹ 12.49 Lakh. Whereas the price of Tigor EV automatic version starts from ₹ 12.49 Lakh.
            <span id="dots">...</span><span id="more">
        
         <br><br><strong>Exterior</strong><br>
         Visually, the Tigor EV gets blue accents on the front grille, wheels, and ‘EV’ badges on front fenders. Besides this, the exterior elements include projector headlamps, bumper-mounted daytime running lights, fog lamps, and 14-inch wheels.
         <br>
 
         <br><br><strong>Interior</strong><br>
        
        
         The cabin of the Tata Tigor EV follows a dual-tone black and grey interior theme. In terms of features, the electric sedan is equipped with automatic climate control, cruise control, a digital instrument cluster, electrically adjustable and foldable OVRMs, an electric tailgate release, leatherette upholstery, a seven-inch touchscreen infotainment system, auto headlamps, a height-adjustable driver seat, and rain-sensing wipers.
        
         <br><br><strong>Electric powertrain</strong><br>
        
        
         The Tigor EV is powered by a 26kWh battery pack with a claimed certified range of 315km. The electric motors produce 74bhp and 170Nm of torque. Furthermore, the electric sedan also gets a four-step re-gen mode.  <br>
         <br>
    ...
    <section style="text-align: center;" id="Brochure">
        <a href="https://tigorev.tatamotors.com/wp-content/themes/tata-nexon/brochure/Tigor.ev-Brochure.pdf" class="btn" target="_blank">Click Here!! For Brochure</a>
    </section>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Tigor EV/Daytona Grey.jpg" alt="Daytona Grey">
                    <div class="content">
                        <h3>Daytona Grey</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Tigor EV/Front View.png" alt="Magnetic Red">
                    <div class="content">
                        <h3>Magnetic Red</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Tigor EV/Signature Teal Blue.jpg" alt="Signature Teal Blue">
                    <div class="content">
                        <h3>Signature Teal Blue</h3>
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/LI_1qcZ_QRM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
...
<section class="Test_drive" id="Test_drive">
    <a href="https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwi8lv3xidb8AhXtmmYCHdQLAScYABACGgJzbQ&ohost=www.google.com&cid=CAESa-D2RJbA_eExD_fO90E3svdvx7RdLukWXqfSjt40A7B-GJ6HW8qJe_QdZSaWrtjrx2z41us-iDvVDfEfkYqVoG4GBHtJCRhH5rZlISJxqFtG88h5RDcEqKyYIwl-txLfqR6MsTl2G0VEDOFo&sig=AOD64_2_ubRm_lj9RSh4pe5tmc3oHC-a8A&adurl&ved=2ahUKEwimnfTxidb8AhXc2HMBHZ0aBi0QqyQoAXoECAgQBg" class="btn" target="_blank">Book a Test Ride</a>
