...
<head>
    ...
    <title>Joy e-bike Hurricane</title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Bike/Joy e-bike Hurricane/download (4).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Hurricane/download (3).jpg" alt="Joy e-bike Hurricane">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Hurricane/download (6).jpg" alt="">
                    <div class="content">
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Hurricane/download (8).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                    </div>
                </div> -->
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Hurricane/download (8).jpg" alt="Super Mileage">
                    <div class="content">
                        <h3>Super Mileage</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Hurricane/download (7).jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Hurricane/download (1).jpg" alt="Body">
                    <div class="content">
                        <h3>Body</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 80 Kms &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- 8 hrs &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 1-2 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 66Ah kwh &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Joy e-Bike, a subsidiary of Wardwizard Innovations & Mobility Ltd., has launched four new electric motorcycles for the Indian market. The Hurricane, one of the four bikes, is priced at Rs 2,29,000 and positioned as a streetfighter. It looks like a complete rip-off of the Kawasaki Z250 with redesigned tank shrouds and a Benelli TNT 300-inspired headlight.  
            <span id="dots">...</span><span id="more">
        
         <br><br>
         In terms of hardware, the bike packs a smaller 73.6V 54Ah lithium-ion battery, rated to deliver a range of 90km. Power is delivered to the rear wheel via a 5kW BLDC hub motor that delivers 230Nm of torque. That said, the torque at the wheel hasn’t been revealed. Customers can charge the bike using a 10Amp charger, however, there's no word on how long it'll take for a full charge.
         <br><br>
         The Hurricane features a telescopic fork and monoshock, twin disc brakes up front, and a single disc at the rear. It may come with CBS, as opposed to ABS, as these bikes top out at 90kmph. 
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Hurricane/download (6).jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Hurricane/download (1).jpg" alt="Blue">
                    <div class="content">
                        <h3>Blue</h3>
                    </div>
                </div> -->
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Hurricane/download (6).jpg" alt="Red">
                    <div class="content">
                        <h3>Red</h3>
                    </div>
                </div>                 -->
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Hurricane/download.jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>                 -->
...
<section class="VIDEO"  id="VIDEO">
    ...
    <br> 
<br> <strong>For More Information : </strong> <a href="https://www.joyebike.com/product/hurricane/" target="_blank" >Click Here </a>

</section>

<section class="Test_drive" id="Test_drive">
    <a href="https://www.joyebike.com/product/hurricane/" class="btn" target="_blank">Book a Test Ride</a>
</section>
