...
<head>
    ...
    <title>Essel Energy GET 7 </title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cycles/Essel Energy GET 7/Essel Energy GET 7.png" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Essel Energy GET 7/White.png" alt="Essel Energy GET 7">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Essel Energy GET 7/Side View.jpg" alt="">
                    <div class="content">
                        <h3>Side View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Essel Energy GET 7/Front View.jpg" alt="">
                    <div class="content">
                        <h3>Front View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Essel Energy GET 7/Cross View.png" alt="">
                    <div class="content">
                        <h3>Cross View</h3>
              ...
              <!--  <div class="swiper-slide box">
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cycles/Essel Energy GET 7/Automatic transmission.png" alt="Automatic transmission">
                    <div class="content">
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 42 thousand 500(42,500)onwards &emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-gears"></i><strong> Transmission</strong> :- Automatic ,m<br>
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 70-80 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
        ...
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 48V/16Ah &nbsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-car-side"></i> <strong> Body Type</strong> :- 2 seater  &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;
       <!-- <i class="fa-solid fa-suitcase-rolling"></i> <strong>Boot</strong> :- 575 kerb -->
     </div>
    </section>
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td> GET 7 11AH Li</td>
                    <td>₹ 42,500</td>
                    <td> Water Proof Cables, Auto Cop With Alarm Sensor, Quick Release Seatpost, Rainwater Guard, Basket
                        Display</td>
                </tr>
                <tr>
                    <td>GET 7 13AH Li</td>
    ...
    <section style="text-align: center;" id="Brochure">
        <a href="https://www.esselenergy.com/pdfs/GET-7.pdf" class="btn" target="_blank">Click Here!! For Brochure</a>
    </section>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Essel Energy GET 7/Black.jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Essel Energy GET 7/White.png" alt="White">
                    <div class="content">
                        <h3>White</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Essel Energy GET 7/Cross View.png" alt="Black-Neon">
                    <div class="content">
                        <h3>Black-Neon</h3>
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/EXpYpc8cTjE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
...
<br> <strong>For More Information : </strong> <a href="https://www.bikedekho.com/essel-energy/get-7" target="_blank" >Click Here </a>
