...
<body>
    ...
    <section class="vehicles" id="vehicles">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Raftaar Cruiser/3.jpeg" alt="">
                    <div class="content">
                        <h3>Speedometer</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Raftaar Cruiser/4.jpeg" alt="">
                    <div class="content">
                        <h3>Rear Tyre</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Raftaar Cruiser/6.jpeg" alt="">
                    <div class="content">
                        <h3>Seat</h3>
    ...
    <section class="Specifications " id="Specifications">
        ...
        <div style="font-size: 1.2vw;">
            <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 85 Thousands onwards &emsp;&emsp;&emsp;&emsp;
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Raftaar Cruiser priced at Rs. 84,500. The claimed mileage . In technical specifications, Raftaar Cruiser is powered by engine , while Simple Energy One is powered by engine. Raftaar Cruiser is available in 4 different colours while Simple Energy
            One comes with 4 colours.
            <span id="dots">...</span><span id="more">
        <br>
        <br>
        The Comparison Raftaar Cruiser vs Simple Energy One can be described on the basis of price and specifications.
        </span>
        </p>
    ...
    <section style="text-align: center;" id="Brochure">
        <a href="https://raftaarelectricvehicles.com/wp-content/uploads/2021/11/cruzer_11zon.pdf" class="btn" target="_blank">Click Here!! For Brochure</a>
    </section>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Raftaar Cruiser/black.jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Raftaar Cruiser/blue.jpg" alt="Blue">
                    <div class="content">
                        <h3>Blue</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Raftaar Cruiser/gray.jpg" alt="Grey">
                    <div class="content">
                        <h3>Grey</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Raftaar Cruiser/red.jpg" alt="Red">
                    <div class="content">
                        <h3>Red</h3>
                    </div>
                </div>
