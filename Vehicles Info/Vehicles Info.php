...
<head>
    ...
    <meta name="View on Road Priceontent="width=device-width, initial-scale=1.0">
...
<body>
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Nexon EV/nexon-ev-prime-exterior-right-front-three-quarter-2.gif" alt="TATA NEXON EV">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    ...
                    <div class="content">
                        <h3>Side View on Road Price
                    </div>
                </div>

                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Nexon EV/TATA NEXON EV 2.png" alt="">
                    <div class="content">
                        <h3>Front View on Road Price
                    </div>
                </div>
    ...
    <!-- OverView on Road Pricecifications of the Vehicle -->
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Tata Nexon EV/Daytona Grey.png" alt="Daytona Grey">
                    <div class="content">
                        <h3>Daytona Grey</h3>
                    </div>
                </div>
    ...
    <section class="footer" id="footer">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="#"> <i class="fas fa-arrow-right"></i> reView on Road Price                <a href="#"> <i class="fas fa-arrow-right"></i> contact </a>
            </div>
