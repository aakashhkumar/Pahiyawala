...
<body>
    ...
    <section class="home" id="home">
        ...
        <h3>Hero Lectro C4</h3>
        <img  src="../image/Cycles/HERO LECTRO C4/LOGO.jpg" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/HERO LECTRO C4/FRONT.png" alt="TATA NEXON EV">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C4/SIDE.png" alt="">
                    <div class="content">
                        <h3>Side View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/HERO LECTRO C4/BACK.png" alt="">
                    <div class="content">
                        <h3>Back View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/HERO LECTRO C4/RHS.png" alt="">
                    <div class="content">
                        <!--<h3>RHS View</h3>-->
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 28,999 &emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 25 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging </strong> :-Up to 30kms in one charge &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;
    ...
    <section class="Summary" id="Summary">
        ...
        <p>The Hero Lectro C4 26 SS runs on a rear hub BLDC 36V 250W rear hub motor. This motor is powered by a 36 Volt, 5.8 AH Lithium-Ion battery. The throttle on the right grip was easy to use and also brought out the fun factor on this E-bicycle.
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/Z0fs2mLYUy4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
