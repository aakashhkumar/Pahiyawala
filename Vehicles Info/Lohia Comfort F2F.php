...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/E-Rickshaw/Lohia Comfort F2F/comfort.jpeg" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/E-Rickshaw/Lohia Comfort F2F/front.jpg" alt="TATA NEXON EV">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/E-Rickshaw/Lohia Comfort F2F/sideeee.jpg" alt="">
                    <div class="content">
                        <h3>Side View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/E-Rickshaw/Lohia Comfort F2F/lhs.png" alt="">
                    <div class="content">
                        <h3>LHS View</h3>
                ...
                <!--<div class="swiper-slide box">
                    <img src="../image/Cars/Tata Nexon EV/Spacious Interior.jpg" alt="TATA NEXON EV Spacious Interior">
                    <div class="content">
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <!--<i class="fa-solid fa-suitcase-rolling"></i> <strong>Brand</strong> :- Lohia-->
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- Rs 1.6-1.8 Lakh &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;
        ...
        <i class="fa-solid fa-gears"></i><strong> Motor Type</strong> :- BLDC Motor <br>
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 100-140 Km/Charge &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :-8-10 Hrs &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 4 Passengers+ 1 Driver <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 40.5 kWh &nbsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Comfort Electric Rickshaw is designed so beautifully which will give all around comfort to its driver & passenger. Our Battery Rickshaw has unique back to back seating with easy footstep which provides convenience to its passengers and extra revenue to its owner.
    ...
    <section style="text-align: center;" id="Brochure">
        <a href="http://lohiaauto.com/brochure/Comfort%20Base%20Plus.pdf" class="btn" target="_blank">Click Here!! For Brochure</a>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/E-Rickshaw/Lohia Comfort F2F/brown.jpg" alt="Daytona Grey">
                    <div class="content">
                        <h3>black-brown</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/E-Rickshaw/Lohia Comfort F2F/red.webp" alt="Pristine White">
                    <div class="content">
                        <h3>Pristine Red</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/E-Rickshaw/Lohia Comfort F2F/silver_black.jpg" alt="Intensi Teal">
                    <div class="content">
                        <h3>Starlight</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/E-Rickshaw/Lohia Comfort F2F/dark green.webp" alt="Starlight">
                    <div class="content">
                        <h3>dark green</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/gwg_4kbnoJE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    <iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/0G_c1hCEdPc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
