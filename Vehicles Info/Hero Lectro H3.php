...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cycles/Hero Lectro H3/download (6).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download (4).jpg" alt="Hero Lectro H3">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download (9).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download (10).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download (4).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download (1).jpg" alt="Comfortable Handle">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download (8).jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download.jpg" alt="Comfy Cusion">
                    <div class="content">
                        <h3>Comfy Cusion</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 28,499.00 onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <section class="Summary" id="Summary">
        ...
        <p>The Hero Lectro H3 is the latest electric cycle from the brand built on the GEMTEC platform which claims

            better ride geometry and smart ergonomics. 
            <span id="dots">...</span><span id="more">
        
         <br><br>
         The Hero Lectro H3 is priced at Rs 28,499. It is powered by a 250W BLDC hub motor paired to a 5.8Ah Li-ion battery pack. It claims a 25kmph top speed and 30km of range on a single charge.
         <br><br>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download (9).jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download (10).jpg" alt="Silver">
                    <div class="content">
                        <h3>Silver</h3>
                    </div>
                </div>
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download (3).jpg" alt="Blue-Black">
                    <div class="content">
                        <h3>Blue-Black</h3>
                    </div>
                </div>                 -->
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro H3/download (4).jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>                 -->
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/qFh0GR8TD0I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    <br> 
<br> <strong>For More Information : </strong> <a href="https://www.herolectro.com/h3-ESLH37CBKGN001_main.html?lectro3d=ESLH37CBKGN001" target="_blank" >Click Here </a>
