...
<body>
    ...
    <section class="home" id="home">
        ...
        <h3>Hero Lectro C7i+</h3>
        <img  src="../image/Cycles/Hero Lectro C7+/logo.jpg" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C7+/front.png" alt="TATA NEXON EV">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C7+/side.png" alt="">
                    <div class="content">
                        <h3>Side View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C7+/back.png" alt="">
                    <div class="content">
                        <h3>Back View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C7+/rhs.png" alt="">
                    <div class="content">
                        <h3>RHS View</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 34,999 &emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 35 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :-6.5 to 15 hrs &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;
        <!--<i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 1 People <br>-->
    ...
    <section class="Summary" id="Summary">
        ...
        <p>This a Electric Hybrid Bicycle built on a full Alloy 6061 frame with a comfort focused ride geometry. The concealed 6.4Ah battery with rear hub motor has a pedal assist mode and a throttle mode. The mechanical disc brakes were powerful for quick stops and the 28” x 1.75” Hybrid tires were grippy and fast rolling.
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C8i/blue-black.png" alt="Daytona Grey">
                    <div class="content">
                        <h3>blue-black</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C8i/silver.jpg" alt="Pristine White">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C8i/yellow.png" alt="Intensi Teal">
                    <div class="content">
                        <h3>Starlight</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C8i/red-black.png" alt="Starlight">
                    <div class="content">
                        <h3>red-black</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/JI_E13HskJo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

    <iframe width="560" height="315" src="https://www.youtube.com/embed/SVWsO1CTAMo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
