...
<head>
    ...
    <title>Hero Lectro Electric C5x</title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <h3>Hero Lectro Electric C5x</h3>
        <img  src="../image/Cycles/Hero Lectro C5X/logo.jpg" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C5X/front.png" alt="TATA NEXON EV">
                    <div class="content">

                        <h3>Hero Lectro Elrctric C5x </h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C5X/lhs.png" alt="">
                    <div class="content">
                        <h3>Side View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C5X/back.png" alt="">
                    <div class="content">
                        <h3>Back View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C5X/side view.png" alt="">
                    <div class="content">
                        <h3>RHS View</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 35,999 &emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 30 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C5X/silver.png" alt="Pristine White">
                    <div class="content">
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/d8NKKkM_-C4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
