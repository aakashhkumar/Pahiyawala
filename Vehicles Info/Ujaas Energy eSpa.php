...
<body>
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eSpa/Screenshot (243).png" alt="">
                    <div class="content">
                        <h3>Front View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eSpa/Screenshot (244).png" alt="">
                    <div class="content">
                        <h3>Headlight</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eSpa/Screenshot (245).png" alt="">
                    <div class="content">
                        <h3>Taillight</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eSpa/Screenshot (246).png" alt="">
                    <div class="content">
                        <h3>Speedometer</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eSpa/Screenshot (247).png" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eSpa/Screenshot (248).png" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eSpa/Screenshot (249).png" alt="">
                    <div class="content">
                        <h3>Boot Space</h3>
    ...
    <section class="Specifications " id="Specifications">
        ...
        <div style="font-size: 1.2vw;">
            <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 49 Thousands onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Ujaas Energy eSpa 60V is the mid variant in the eGo LA lineup and is priced at Rs. 48,174 (ex-showroom, Delhi). This 60V variant comes with an engine putting out and of max power and max torque respectively.
        ...
        <h1 class="heading"> <span>Colour</span> Variants </h1>
            ...
            <div class="swiper featured-slider">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide box">
                        <img src="../image/Scooter/Ujaas Energy eSpa/Screenshot (243).png" alt="Red">
                        <div class="content">
                            <h3>Red</h3>
                        </div>
                    </div>
