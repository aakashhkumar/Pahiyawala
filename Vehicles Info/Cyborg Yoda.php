...
<body>
    ...
    <section class="home" id="home">
        ...
        <h3>Cyborg Yoda</h3>
        <img  src="../image/Bike/Cyborg Yoda/download (5).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download (1).jpg" alt="Cyborg Yoda">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download (2).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download (6).jpg" alt="">
                    <div class="content">
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download (8).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                    </div>
                </div> -->
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download (7).jpg" alt="Super Mileage">
                    <div class="content">
                        <h3>Super Mileage</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download (3).jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download (8).jpg" alt="Body">
                    <div class="content">
                        <h3>Body</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 1.85 Lakh onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 150 Kms &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- 4-5 hrs &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 1-2 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 3.24 kwh &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <!-- <i class="fa-solid fa-car-side"></i> <strong> Body Type</strong> :- SUV &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
        <i class="fa-solid fa-bicycle"></i> <strong>Max speed</strong> :- 90 kmph
     </div>
    </section>
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Yoda STD</td>
                    <td>₹ 1,84,999</td>
                    <td>Parking Mode, Riding Mode - Eco | Drive | Sports, Touch-Safe Battery, Weather Proof Battery, BMS Battery, Geo locate</td>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Yoda is a Cruiser bike from Cyborg. Least expensive Cyborg Yoda variant is STD which is sold in Indian automobile market at an ex-showroom price 
            <span id="dots">...</span><span id="more">
        
         <br><br>
         Cyborg Yoda bike price starts at Rs 1.84 Lakh (ex-showroom). Check Cyborg Yoda range, specifications, charging time, colors & images.
         <br><br>
         The electric cruiser Yoda will act as the company’s flagship, catering to Indian motorcycle enthusiasts and customers a like. According to Ignitron, this scooter can tackle the latest challenging and most extreme Indian terrain with a strong style focus. Along with being India’s first electric cruiser with a swappable battery, the e-Scooty aims to target long-range ride automotive enthusiasts.
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download (7).jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download (13).jpg" alt="Deep Blue">
                    <div class="content">
                        <h3>Deep Blue</h3>
                    </div>
                </div> -->
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download (12).jpg" alt="Garnet Red">
                    <div class="content">
                        <h3>Garnet Red</h3>
                    </div>
                </div>                 -->
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Yoda/download.jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>                 -->
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/6H-wNBpIvwk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    <!-- <iframe width="560" height="315" src="https://komaki.in/ranger/" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> -->
    ...
    <br> 
<br> <strong>For More Information : </strong> <a href="https://cyborgev.com/" target="_blank" >Click Here </a>

</section>

<section class="Test_drive" id="Test_drive">
    <a href="https://cyborgev.com/scheduleAtestRide" class="btn" target="_blank">Book a Test Ride</a>
</section>
