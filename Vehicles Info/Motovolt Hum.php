...
<body>
    ...
    <section class="home" id="home">
        ...
        <h3>Motovolt Hum</h3>
        <img  src="../image/Cycles/Motovolt Hum/download (5).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Hum/download.jpg" alt="Motovolt Hum">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Hum/download.png" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Hum/download (8).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Hum/download (2).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Hum/download (3).jpg" alt="Motovolt Hum with carrier">
                    <div class="content">
                        <h3>With carrier</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Hum/download (6).jpg" alt="Comfy Cusion">
                    <div class="content">
                        <h3>Comfy Cusion</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 31,049.00 onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 20-70 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&emsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- 3-6 hrs &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
    ...
    <section class="Price_Variants" id="Price_Variants">
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Hum Basic- Normal Range</td>
                    <td>₹ 31,049</td>
                    <td>Acceleration (0-25 kmph) - 9 Sec, Noise - 63 db, 4” Multi-Functional Display, Mount For Accessories, Battery Weight (MR or LR)- 4.8 Kg</td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
                <tr>
                    <td>Hum Standard- Normal Range</td>
                    <td>₹ 31,849</td>
                    <td>Acceleration (0-25 kmph) - 9 Sec, Noise - 63 db, 4” Multi-Functional Display, Mount For Accessories, Battery Weight (MR or LR)- 4.8 Kg</td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Motovolt Hum is an electric two wheeler with a price tag ranging between Rs.31,049 to Rs. 43,434.It is available in 16 variants and 4 colours. and has a top speed of 25 kmph.
            <span id="dots">...</span><span id="more">
        
         <br><br>
         <br>
         The price of Motovolt Hum in India starts at Rs. 31,049 and goes upto Rs. 43,434. Motovolt Hum comes with 16 variants which includes Hum Basic - Normal Range, Hum Standard - Normal Range. The top variant is Hum Smart Plus - Long Range Fast Charge which comes at a price tag of Rs. 43,434.
         The Motovolt Hum is built solidly, yet it feels light due to the use of steel in its frame—keeping the bike solid and lightweight at the same time makes it easy to zip through even against a strong breeze.
         <br><br>
         <br>

         The stylish design, high-quality components, and robust build on the Motovolt Hum electric bike will provide you with an amazing experience in your commute. Features such as these, make the Motovolt Hum electric bike ideal for use on smooth as well as rough terrain. Hence, pick up the Motovolt Hum electric bike today, contribute towards leaving ensuring a sustainable future, and have an amazing commuting experience.
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Hum/download.jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Hum/download.png" alt="Orange">
                    <div class="content">
                        <h3>Orange</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Hum/download (8).jpg" alt="Blue">
                    <div class="content">
                        <h3>Blue</h3>
                    </div>
                </div>                
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Hum/download (1).jpg" alt="White">
                    <div class="content">
                        <h3>White</h3>
                    </div>
                </div>                
...
<br> <strong>For More Information : </strong> <a href="https://www.motovolt.co/electric-cycle-hum" target="_blank" >Click Here </a>
