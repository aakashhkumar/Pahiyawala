...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Bike/Joy e-bike Beast/download (4).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/download.jpg" alt="Joy e-bike Beast">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/download (2).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/download (3).jpg" alt="">
                    <div class="content">
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/download (8).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                    </div>
                </div> -->
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/download (7).jpg" alt="Super Mileage">
                    <div class="content">
                        <h3>Super Mileage</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/download (5).jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/images.jpg" alt="Body">
                    <div class="content">
                        <h3>Body</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 2.42 Lakh onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/download (6).jpg" alt="Green">
                    <div class="content">
                        <h3>Green</h3>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/download (1).jpg" alt="Blue">
                    <div class="content">
                        <h3>Blue</h3>
                    </div>
                </div> -->
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/download (6).jpg" alt="Red">
                    <div class="content">
                        <h3>Red</h3>
                    </div>
                </div>                 -->
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Beast/download (1).jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>                 -->
...
<section class="VIDEO"  id="VIDEO">
    ...
    <br> 
<br> <strong>For More Information : </strong> <a href="https://www.joyebike.com/product/beast/" target="_blank" >Click Here </a>

</section>

<section class="Test_drive" id="Test_drive">
    <a href="https://www.joyebike.com/product/beast//" class="btn" target="_blank">Book a Test Ride</a>
</section>
