...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cycles/Hero Lectro C1/download (6).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C1/download (5).jpg" alt="Hero Lectro C1">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C1/download (10).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C1/download (7).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C1/download (9).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C1/download (4).jpg" alt="Foldable">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C1/download (8).jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C1/download (10).jpg" alt="Comfy Cusion">
                    <div class="content">
                        <h3>Comfy Cusion</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 30,999.00 onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Hero Lectro C1 is an electric two wheeler with a price tag of Rs.30,999.It is available in 1 variant and 3 colours.C1 takes approx 3 - 4 hours for a full charge and has a top speed of 25 kmph.
            <span id="dots">...</span><span id="more">
        
         <br><br>
         <br>
         Hero Lectro has launched the brand new C1 as part of its entry-level offering. Priced at Rs 32,999, it’s the third most affordable cycle in Hero’s portfolio. It’s available in three colours: blue, brown and white.

         In terms of features, the cycle comes with a new high-power lithium-ion removable battery that can be fully charged in 3-4 hours. It’s dust and waterproof (IP67 and IP65-rated) resistant. Paired with the 250W BLDC motor it’s capable of offering a claimed range of up to 30km using peddle assist and 25km on throttle per charge. Hero claims a top speed of 25kmph.
         <br><br>
         <br>
         Other notable features include dual wall alloy rims, RFID key locking, and an LED module, which displays the charge status and controls four riding modes.
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C1/download (8).jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C1/download (4).jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro C1/download (7).jpg" alt="Blue">
                    <div class="content">
                        <h3>Blue</h3>
                    </div>
                </div>                
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/0qdQFe9KDBE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    
    <br> 
<br> <strong>For More Information : </strong> <a href="https://www.herolectro.com/c1-ESLC17CBLBK001_main.html" target="_blank" >Click Here </a>
