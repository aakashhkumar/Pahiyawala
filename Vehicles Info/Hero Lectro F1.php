...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cycles/Hero Lectro F1/download (4).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download (3).jpg" alt="Hero Lectro F1">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download (7).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download (6).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download (2).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download.jpg" alt="Comfortable Handle">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download (9).jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download (10).jpg" alt="Comfy Cusion">
                    <div class="content">
                        <h3>Comfy Cusion</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 38,999.00 onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- Upto 30 Kms &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- 3-4 hrs &nbsp;&emsp;&emsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 1-2 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- Li-ion 5.8 Ah &nbsp;&emsp;&emsp;&emsp;
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>F1 STD</td>
                    <td>₹ 38,999</td>
                    <td>Head Set - Neco thread less with Safety lock Black, Chain - 1.27 cm x 0.317 cm, Pedals - Anti-skid Alloy pedals, Chain Wheel - Rugged 40Tx170MM Steel Crank, Saddle - Comfortable Premium Saddle, Brake lever - Alloy 3- finger, Front Hub - Quick Release imported hub, Stand - Chain stay mounted, Side stand - Chain stay mounted, Chain stay mounted, Side stand - Chain stay mounted, Side stand, Handle Bar - 680mm Featherlight Alloy</td>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Hero Lectro has introduced the brand new F1 as part of its premium e-cycle lineup. It’s priced at Rs 38,999 with two colour options on offer: black and red.
            <span id="dots">...</span><span id="more">
        
         <br><br>
         For 2022, Hero has added a new high-power lithium-ion removable battery to the mix, which can be fully charged in 3-4 hours. It’s dust and waterproof (IP67 and IP65-rated) resistant. Paired with the 250W BLDC motor it’s capable of offering a claimed range of up to 30km using peddle assist and 25km on throttle per charge. The top speed is capped at a claimed 25kmph.

        Its feature list includes RFID key locking, and an LED module, which displays the charge status and controls four riding modes.
         <br><br>
         In terms of underpinnings, the cycle uses a front suspension, 7-speed Shimano drivetrain, front and rear disc brakes, and off-road-centric tyres with a quick-release front wheel.
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download (6).jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download (11).jpg" alt="Red">
                    <div class="content">
                        <h3>Red</h3>
                    </div>
                </div>
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download (3).jpg" alt="Blue-Black">
                    <div class="content">
                        <h3>Blue-Black</h3>
                    </div>
                </div>                 -->
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro F1/download (4).jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>                 -->
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/ibHNejMoiP0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    
    <iframe width="560" height="315" src="https://www.youtube.com/embed/_1VGBXhbc-8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    
    <br> 
<br> <strong>For More Information : </strong> <a href="https://www.herolectro.com/f1-ESLF127BKBK001_main.html" target="_blank" >Click Here </a>

</section>

<section class="Test_drive" id="Test_drive">
    <a href="https://www.herolectro.com/book-test-ride" class="btn" target="_blank">Book a Test Ride</a>
</section>
