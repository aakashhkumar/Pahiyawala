...
<body>
    ...
    <section class="home" id="home">
        ...
        <h3>Cyborg Bob-e</h3>
        <img  src="../image/Bike/Cyborg Bob-e/download (6).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download (3).jpg" alt="Cyborg Bob-e">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download (8).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download (11).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download (9).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download (1).jpg" alt="Super Mileage">
                    <div class="content">
                        <h3>Super Mileage</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download (2).jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download (4).jpg" alt="Body">
                    <div class="content">
                        <h3>Body</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 94,999 onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 110 Kms &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 2.88 kwh &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Bob-e STD</td>
                    <td>₹ 94,999</td>
                    <td>USB charger, Swappable battery, Digital cluster, Urban Mode ( Reverse Mode, Parking Mode, Eco Mode, Drive Mode, Sports Mode ), 15amp Fast Charger, Touch-Safe, Easily Portable, Weather Proof, Display & Touch screen</td>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Cyborg Bob-e derives design inspiration from dirt motorbikes. It has a compact, sporty profile with features such as low-set handlebar, sleek LED headlamp and DRL, raised front fender, trendy LED turn signals, single-piece seat and elevated tail section.
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download (8).jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download (13).jpg" alt="Deep Blue">
                    <div class="content">
                        <h3>Deep Blue</h3>
                    </div>
                </div> -->
                <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download (10).jpg" alt="Red">
                    <div class="content">
                        <h3>Red</h3>
                    </div>
                </div>                
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Cyborg Bob-e/download.jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>                 -->
