...
<head>
    ...
    <title>Motovolt Urbn e-bike</title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cycles/Motovolt Urbn e-bike/download (3).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download (1).jpg" alt="Motovolt Urbn e-bike">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download (6).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download.jpg" alt="">
                    <div class="content">
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download (2).jpg" alt="">
                    <div class="content">
                        <h3></h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download (4).jpg" alt="Motovolt Urbn e-bike with carrier">
                    <div class="content">
                        <h3>With carrier</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download (2).jpg" alt="Comfy Cusion">
                    <div class="content">
                        <h3>Comfy Cusion</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download (5).jpg" alt="4 Shades">
                    <div class="content">
                        <h3>4 Shades</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 49,999.00 onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- Upto 120kms &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- Upto 4 hrs &nbsp;&emsp;&emsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 1-2 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- Li-ion 36 V / 20 Ah &nbsp;&emsp;
    ...
    <section class="Price_Variants" id="Price_Variants">
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Urbn e-Bike STD</td>
                    <td>₹ 49,999</td>
                    <td>Tyre air pressure - 30-60 psi, Noise - 63 db, 0-25 - 10 Sec</td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
                <tr>
                    <td>Urbn e-Bike Smart Plus</td>
                    <td>₹ 54,999</td>
                    <td>Tyre air pressure - 30-60 psi, Noise - 63 db, 0-25 - 10 Sec, App Connected Via SIM</td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
                <!-- <tr>
                    <td>Hum Smart- Normal Range</td>
                    <td>₹ 34,100</td>
                    <td>Acceleration (0-25 kmph) - 9 Sec, Noise - 63 db, 4” Multi-Functional Display, Mount For Accessories,  Battery Weight (MR or LR)- 4.8 Kg, Connected Data Features</td>
                    <td><a href="#" class="btn">buy</a></td>
                </tr>
                <tr>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Motovolt Urbn e-Bike is an electric two wheeler with a price tag ranging between Rs.49,999 to Rs. 54,999.It is available in 2 variants and 5 colours.Urbn e-Bike takes approx 4 Hours for a full charge and has a top speed of 25 kmph.
            <span id="dots">...</span><span id="more">
        
         <br><br>
         <br>
         The price of Motovolt Urbn e-Bike in India starts at Rs. 49,999 and goes upto Rs. 54,999. Motovolt Urbn e-Bike comes with 2 variants which includes Urbn e-Bike STD. The top variant is Urbn e-Bike Smart Plus which comes at a price tag of Rs. 54,999.
         Motovolt smart cycles are India's best electric cycle and made it's name with best quality and riding experience.
         <br><br>
         <br>
         Motovolt has launched the Urbn e-bike for a price of Rs 49,999 (ex-showroom). It gets a Lithium-ion removable battery offering a claimed range of upto 120 km and it can be fully charged in four hours.The Urbn e-bike can accelerate from 0-25kmph in less than 10 seconds and it also comes with pedal assist. Top speed is restricted to 25kmph as it’s a low-speed offering.
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download.jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download (8).jpg" alt="Orange">
                    <div class="content">
                        <h3>Orange</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download (1).jpg" alt="Blue">
                    <div class="content">
                        <h3>Blue</h3>
                    </div>
                </div>                
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Motovolt Urbn e-bike/download (4).jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>                
...
<br> <strong>For More Information : </strong> <a href="https://www.motovolt.co/urbn-e-bike" target="_blank" >Click Here </a>
