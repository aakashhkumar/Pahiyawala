...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cars/Audi RS E-Tron GT/RS ETRON BACKDROp.jpg" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Front View.jpg" alt=" Audi RS E-Tron GT">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Front View.jpg" alt="">
                    <div class="content">
                        <h3>Front View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Back Side.png" alt="">
                    <div class="content">
                        <h3>Back Side</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Interior.jpg" alt="Interior">
                    <div class="content">
                        <h3>Interior</h3>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/ Automatic transmission.png" alt="Automatic transmission">
                    <div class="content">
               ...
               <!-- <div class="swiper-slide box">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/" alt="">
                    <div class="content">
                        <h3> </h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        ...
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :-5 hours 15 minutes &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;
        ...
        <i class="fa-solid fa-suitcase-rolling"></i> <strong>Boot</strong> :- 405 litres
     </div>
    </section>
    ...
    <section class="Price_Variants" id="Price_Variants">
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>RS E-Tron GT Quattro</td>
                    <td>₹ 1.94 Crore</td>
                    <td> Cruise Control, Push Button Start, Wireless Charger, Alloy Wheels, Steering Mounted Controls</td>
                    <td><a href="../Road Price/Audi_etron.php" class="btn">View on road price</a></td>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>The Audi RS e-tron GT has on offer. It is available with the Automatic transmission. The RS e-tron GT is a 5 seater and has length of 4989mm, width of 1964mm and a wheelbase of 2903mm.
            <span id="dots">...</span><span id="more">
        
         <br><br><strong>Exterior</strong><br>
        
         Design the exterior of your Audi RS e-tron GT to your liking. Whether the exterior colour, rim or headlights technology: You can turn your Audi RS e-tron GT into your personalised dream car using the numerous equipment options. <br>
         <br>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Suzuki gray metallic.png" alt="">
                    <div class="content">
                        <h3>Mythos black metallic</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Tango red metallic.png" alt="">
                    <div class="content">
                        <h3>Tango red metallic</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Suzuki gray metallic.png" alt="">
                    <div class="content">
                        <h3>Suzuki gray metallic</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Kemora gray Metallic.png" alt="">
                    <div class="content">
                        <h3>Kemora  gray metallic</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Daytona gray pearl effect.png" alt="">
                    <div class="content">
                        <h3>Daytona gray pearl effect</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Ascari blue metallic.png" alt="">
                    <div class="content">
                        <h3>Ascari blue metallic</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Floret silver metallic.png" alt="">
                    <div class="content">
                        <h3>Floret silver metallic</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Ibis white metallic.png" alt="">
                    <div class="content">
                        <h3>Ibis white metallic</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Cars/Audi RS E-Tron GT/Tactical green metallic.png" alt="">
                    <div class="content">
                        <h3>Tactical green metallic</h3>
                    </div>
                </div>
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/BNVZmrxXuuU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
...
<br> <strong>For More Information : </strong> <a href="https://www.audi.in/in/web/en/models/e-tron-gt/audi-rs-e-tron-gt.html" target="_blank" >Click Here </a>

</section>

<section class="Test_drive" id="Test_drive">
    <a href="https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwjksJbf4cz8AhUTHCsKHXgHC4UYABAAGgJzZg&ohost=www.google.com&cid=CAESa-D2jGrMQOTDWSoJTBCvt4Q-n9ZZUSBdtimFdQ69lfeCRx4OO7WfVsIw9hOpOXbn_iDQaiRzrsKsNEB8voCxwviGdqYmaY1se3w5yuqGJaolFrlFdu3hGtT5yyMshu0ZDjty0cRPcpXWZQ3m&sig=AOD64_1kj8oVyF3ge6TvroZ5NW-lzmOuUw&q&adurl&ved=2ahUKEwjOko_f4cz8AhUTSXwKHUvlBP0Q0Qx6BAgGEAE" class="btn" target="_blank">Book a Test Ride</a>
