...
<head>
    ...
    <title>One Electric Motorcycles Kridn</title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Bike/One Electric Motorcycles Kridn/download (6).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download (1).jpg" alt="One Electric Motorcycles Kridn">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download (7).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download.jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download (3).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download (5).jpg" alt="Super Mileage">
                    <div class="content">
                        <h3>Super Mileage</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download.jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download (2).jpg" alt="Body">
                    <div class="content">
                        <h3>Body</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 1.35 Lakh onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 80-110 Kms &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- 5-8 hrs &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 1-2 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 3 kwh &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <!-- <i class="fa-solid fa-car-side"></i> <strong> Body Type</strong> :- SUV &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
        <i class="fa-solid fa-bicycle"></i> <strong>Max speed</strong> :- 95 kmph
     </div>
    </section>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>One Electric Motorcycles Kridn is an electric two wheeler with a price tag of Rs.1.35 Lakh.It is available in 1 variant and 1 colour. and has a top speed of 95 kmph
            <span id="dots">...</span><span id="more">
        
         <br><br>
         One Electric KRIDN ELECTRIC. One Electric KRIDN is a electric Motorcycle available at a price range of Rs. 1.29 Lakh to 1.29 Lakh in India. 
         <br><br>
         One Electric KRIDN mileage is 110 kmph on ECO mode, and 80 kmph in the Normal mode.
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download (3).jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download (4).jpg" alt="Blue">
                    <div class="content">
                        <h3>Blue</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download (2).jpg" alt="Red">
                    <div class="content">
                        <h3>Red</h3>
                    </div>
                </div>                
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/One Electric Motorcycles Kridn/download (1).jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>                 -->
...
<section class="VIDEO"  id="VIDEO">
    ...
    <!-- <iframe width="560" height="315" src="https://www.youtube.com/embed/yUy83V-RBeI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> -->
    <br> 
<br> <strong>For More Information : </strong> <a href="https://oneelectric.in/" target="_blank" >Click Here </a>
