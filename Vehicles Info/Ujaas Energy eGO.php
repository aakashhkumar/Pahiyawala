...
<body>
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eGO/Screenshot (235).png" alt="">
                    <div class="content">
                        <h3>Front View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eGO/Screenshot (236).png" alt="">
                    <div class="content">
                        <h3>Headlight</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eGO/Screenshot (237).png" alt="">
                    <div class="content">
                        <h3>Taillight</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eGO/Screenshot (238).png" alt="">
                    <div class="content">
                        <h3>Speedometer</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eGO/Screenshot (239).png" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eGO/Screenshot (240).png" alt="">
                    <div class="content">
                        <h3>Indicator Controller</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eGO/Screenshot (241).png" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Scooter/Ujaas Energy eGO/Screenshot (242).png" alt="">
                    <div class="content">
                        <h3>Back Rest View</h3>
    ...
    <section class="Specifications " id="Specifications">
        ...
        <div style="font-size: 1.2vw;">
            <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 35 Thousands onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
            ...
            <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 75 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity </strong> :- 1.56 kWh &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Ujaas Energy eGO 60V is the mid variant in the eGo LA lineup and is priced at Rs. 39,880 (ex-showroom, Delhi). This 60V variant comes with an engine putting out and of max power and max torque respectively. Ujaas Energy eGO 60V is available in
            2 colours :
        ...
        <h1 class="heading"> <span>Colour</span> Variants </h1>
            ...
            <div class="swiper featured-slider">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide box">
                        <img src="../image/Scooter/Ujaas Energy eGO/Screenshot (233).png" alt="Red">
                        <div class="content">
                            <h3>Red</h3>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide box">
                        <img src="../image/Scooter/Ujaas Energy eGO/Screenshot (234).png" alt="Blue">
                        <div class="content">
                            <h3>Blue</h3>
                        </div>
                    </div>
