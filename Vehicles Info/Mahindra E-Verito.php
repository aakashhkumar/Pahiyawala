...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cars/Mahindra E-Verito/Mahindra E-Verito.png" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mahindra E-Verito/Mahindra E Verito.jpg" alt="Mahindra E-Verito">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mahindra E-Verito/Side View.jpg" alt="">
                    <div class="content">
                        <h3>Side View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mahindra E-Verito/Front View.jpg" alt="">
                    <div class="content">
                        <h3>Front View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mahindra E-Verito/Inside View.jpg" alt="">
                    <div class="content">
                        <h3>InsideView</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mahindra E-Verito/Interiors.jpg" alt=" Interior">
                    <div class="content">
                        <h3> Interior</h3>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cars/Mahindra E-Verito/Automatic transmission.png" alt="Automatic transmission">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mahindra E-Verito/" alt="">
                    <div class="content">
                        <h3> </h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 9.13 Lakh onwards &emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 288ah &nbsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-car-side"></i> <strong> Body Type</strong> :- 5 seater sedan  &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <i class="fa-solid fa-suitcase-rolling"></i> <strong>Boot</strong> :- 510 litres
     </div>
    </section>
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>E-Verito D2</td>
                    <td>₹ 9.13 Lakh</td>
                    <td> Mahindra E Verito D2 is a 5 seater Electric(Battery) car. E Verito D2 has Multi-function Steering Wheel,Power Adjustable Exterior Rear View Mirror,Touch Screen,Automatic Climate Control,Engine Start Stop Button,Anti Lock Braking System,Alloy Wheels,Fog Lights - Front,Fog Lights - Rear,Power Windows Rear
                ...
                <tr>
                    <td>E-Verito D6</td>
                    <td>₹ 9.46</td>
                    <td>Mahindra E Verito D6 is a 5 seater Electric(Battery) car. E Verito D2 has Multi-function Steering Wheel,Power Adjustable Exterior Rear View Mirror,Touch Screen,Automatic Climate Control,Engine Start Stop Button,Anti Lock Braking System,Alloy Wheels,Fog Lights - Front,Fog Lights - Rear,Power Windows Rear
    ...
    <section class="Summary" id="Summary">
        ...
        <p>The price of Mahindra E Verito starts at Rs. 9.13 Lakh and goes upto Rs. 9.46 Lakh. Mahindra E Verito is offered in 2 variants - the base model of E Verito is D2 and the top variant Mahindra E Verito D6 which comes at a price tag of Rs. 9.46 Lakh.
            <span id="dots">...</span><span id="more">
        
         <br><br><strong>Exterior</strong><br>
        
         Identical to the regular version, e-Verito sports styling elements such as body coloured bumpers, chrome front grille, side cladding, body side decals and side indicator on the outside.  <br>
         <br>
         ...
         Borrowing cues from the standard model, e-Verito gets similar interior with a premium dual tone colour scheme and fabric upholstery. Silver accent around AC vents and knobs add to the overall styling. 
        
         <br><br><strong>Electric powertrain</strong><br>
        
        
         The car is based on Mahindra’s slow-selling Verito sedan that is otherwise offered with a 1.5-litre diesel engine. Like the e2o, the e-Verito runs on electricity alone. It is powered by a three-phase 72V electric motor that produces 41PS of power and 91Nm of torque. The model has a claimed range of 110km (e2o = 120km), with the top speed rated at a modest 86 kmph.   <br>
         <br>
    ...
    <section style="text-align: center;" id="Brochure">
        <a href="https://www.mahindraelectric.com/pdfs/eVERITO-Brochure.pdf" class="btn" target="_blank">Click Here!! For Brochure</a>
    </section>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mahindra E-Verito/Silver.jpg" alt="Silver">
                    <div class="content">
                        <h3>Silver</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mahindra E-Verito/Front View.jpg" alt=White">
                    <div class="content">
                        <h3>White</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/GNy9mNZdjfI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
...
<br> <strong>For More Information : </strong> <a href="https://www.mahindraelectric.com/vehicles/everito/" target="_blank" >Click Here </a>

</section>

<section class="Test_drive" id="Test_drive">
    <a href="https://www.mahindraelectric.com/book-test-drive/" class="btn" target="_blank">Book a Test Ride</a>
