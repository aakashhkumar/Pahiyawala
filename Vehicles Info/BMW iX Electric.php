...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cars/BMW iX Electric/Bmw iX Electric.png" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/BMW iX Electric/Front View.png" alt="BMW iX Electric">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/BMW iX Electric/Front View.png" alt="">
                    <div class="content">
                        <h3>Front View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/BMW iX Electric/Cross View.png" alt="">
                    <div class="content">
                        <h3>Cross View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/BMW iX Electric/Interior.jpg" alt=" Interior">
                    <div class="content">
                        <h3> Interior</h3>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cars/BMW iX Electric/Automatic transmission.png" alt="Automatic transmission">
                    <div class="content">
           ...
           <!--     <div class="swiper-slide box">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/BMW iX Electric/" alt="">
                    <div class="content">
                        <h3> </h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 1.16 crore onwards &emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 372- 425 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :-7 hours 25 minutes &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;
        ...
        <i class="fa-solid fa-suitcase-rolling"></i> <strong>Boot</strong> :- 500 litres 
     </div>
    </section>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>The price of BMW iX starts at Rs. 1.16 Cr and goes upto Rs. 1.16 Cr. BMW iX is offered in 1 variants - the base model of iX is xDrive40 and the top variant BMW iX xDrive40 which comes at a price tag of Rs. 1.16 Cr.
            <span id="dots">...</span><span id="more">
        
         <br><br><strong>Exterior</strong><br>
        
         The BMW iX has 1 Electric Engine on offer. It is available with the Automatic transmission. The iX is a 5 seater and has length of 4953mm, width of 2230mm and a wheelbase of 3000mm. <br>
         <br>
    ...
    <section style="text-align: center;" id="Brochure">
        <a href="https://www.bmw-gallopsautohaus.in/sites/default/files/2022-04/The%20BMW%20iX%20%E2%80%93%20Brochure.pdf" class="btn" target="_blank">Click Here!! For Brochure</a>
    </section>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/BMW iX Electric/Cross View.png" alt="White">
                    <div class="content">
                        <h3>White</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/BMW iX Electric/Cross View.png" alt="Brown">
                    <div class="content">
                        <h3>Brown</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/BMW iX Electric/Red.png" alt="Red">
                    <div class="content">
                        <h3>Red</h3>
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/eKYAldc8bbc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
...
<br> <strong>For More Information : </strong> <a href="https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwiO2Z3cgc78AhWYNSsKHbn7DMwYABAAGgJzZg&ohost=www.google.com&cid=CAESa-D2NBYqPs-UrgIH6jR974ZbVt2OSe6EiOIxVWflU1RGzQOpWJr68lORCMtLQ_ZEYi9Tj_qz1tc7Y7SCj4U2CmfO1BRdrERwpg9UqISmV0RR1AO8mGIBtRkKHPra3RvWjrG9dhbeC9PELRbA&sig=AOD64_0I2wxK0iLh5NYKQlAP0yyE0R0PEg&q&adurl&ved=2ahUKEwiFlpbcgc78AhXk6zgGHYtBBroQ0Qx6BAgHEAM" target="_blank" >Click Here </a>

</section>

<section class="Test_drive" id="Test_drive">
    <a href="https://www.googleadservices.com/pagead/aclk?sa=L&ai=DChcSEwjh9vnvgc78AhWAmGYCHd3uC3QYABABGgJzbQ&ohost=www.google.com&cid=CAESa-D2MiwVowBtHMTN60u-UYCG9pJVX-4lYUAGNbBT29fkRPhNnoyETj5QmyJO9h1GGtUTP5-Or4lDAHzt4qKlc1bp1hptVRor0d_cLn9XFQaBWMLZXRYJLV8tz3t_FuteYtCF6UVq1UFdJQMC&sig=AOD64_1IoY7bR-LWtMStd5YXvuWFhtvkLw&q&adurl&ved=2ahUKEwi7wvLvgc78AhVL7TgGHSOFAvYQ0Qx6BAgIEAE" class="btn" target="_blank">Book a Test Ride</a>
