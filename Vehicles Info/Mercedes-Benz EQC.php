...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Cars/Mercedes-Benz EQC/Mercedes Benz EQC.png" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mercedes-Benz EQC/Mercedes-Benz EQC.jpg" alt="Mercedes-Benz EQC">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mercedes-Benz EQC/Side View.png" alt="">
                    <div class="content">
                        <h3>Side View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mercedes-Benz EQC/Cross View.jpg" alt="">
                    <div class="content">
                        <h3>Cross View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mercedes-Benz EQC/Interior.jpg" alt="Interior">
                    <div class="content">
                        <h3>Interior</h3>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Cars/Mercedes-Benz EQC/Automatic transmission.png" alt="Automatic transmission">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mercedes-Benz EQC/" alt="">
                    <div class="content">
                        <h3> </h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 99.50 Lakh onwards &emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 451-471 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :-7.2 hours &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 5 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 80 kWh &nbsp;&emsp;&emsp;&emsp;
    ...
    <section class="Summary" id="Summary">
        ...
        <p>The price of Mercedes-Benz EQC starts at Rs. 99.50 Lakh and goes upto Rs. 99.50 Lakh. Mercedes-Benz EQC is offered in 1 variants - the base model of EQC is 400 4MATIC and the top variant Mercedes-Benz EQC 400 4MATIC which comes at a price tag of Rs. 99.50 Lakh.
         ...
         It comes with a 7.4kWh home charger that can charge the electric SUV from 10 to 100 percent in 10 hours. It works on a regular 15amp socket, delivering a maximum of 3.4kWh of electricity, and can complete the 10 to 100 percent charge in 21 hours.   <br>
         <br>
        
        
         he EQC gets an 80kWh battery pack that powers two electric motors, one on each axle. The total output of these motors is 408PS and 760Nm. As per NEDC (New European Driving Cycle), the EQC can be driven more than 450km with the battery pack fully charged.
        </span>
        </p>
    ...
    <section style="text-align: center;" id="Brochure">
        <a href="https://www.cartrade.com/mercedes-benz-cars/eqc/brochures/" class="btn" target="_blank">Click Here!! For Brochure</a>
    </section>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mercedes-Benz EQC/Front View.jpg" alt="Grey">
                    <div class="content">
                        <h3>Grey</h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cars/Mercedes-Benz EQC/Cross View.jpg" alt="White">
                    <div class="content">
                        <h3>White</h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/FmPiAoQujo0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
...
<br> <strong>For More Information : </strong> <a href="https://www.mercedes-benz.co.in/passengercars/mercedes-benz-cars/models/eqc/explore.html" target="_blank" >Click Here </a>
