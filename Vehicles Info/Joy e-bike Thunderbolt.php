...
<head>
    ...
    <title>Joy e-bike Thunderbolt</title>
...
<body>
    ...
    <section class="home" id="home">
        ...
        <img  src="../image/Bike/Joy e-bike Thunderbolt/download (5).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/images.jpg" alt="Joy e-bike Thunderbolt">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/download (4).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/download (6).jpg" alt="">
                    <div class="content">
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/download (8).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                    </div>
                </div> -->
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/download.jpg" alt="Super Mileage">
                    <div class="content">
                        <h3>Super Mileage</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/download (7).jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/download (2).jpg" alt="Body">
                    <div class="content">
                        <h3>Body</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 2.33 Lakh onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 110 Kms &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- 9 hrs &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 1-2 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 72Ah kwh &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <section class="Price_Variants" id="Price_Variants">
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Thunderbolt STD</td>
                    <td>₹ 2.33 Lakh</td>
                    <td>Automatic, Double Disc, Hub Motor</td>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Joy e-Bike has launched four new electric motorcycles, one of which is called the Beast. The streetfighter, which looks like a carbon copy of the Kawasaki Z250, is priced at Rs 2,42,000. The bike’s headlight is reminiscent of the Z1000 and the bodywork of the Z250 with minor revisions here and there. 
            <span id="dots">...</span><span id="more">
        
         <br><br>
         It packs a 73.6V 72Ah lithium-ion battery rated to deliver a range of 110km. Power is delivered to the rear wheel via a 5kW BLDC hub motor that delivers 230Nm of torque. That said, the torque at the wheel hasn’t been revealed. Customers can charge the bike using a 10Amp charger, however, there's no word on how long it'll take for a full charge. 

         In terms of underpinnings, the Beast features a telescopic fork and monoshock, twin disc brakes up front, and a single disc at the rear. It may come with CBS as opposed to ABS.
         <br><br>
         According to the company, the Beast comes with Internet of Things (IoT) sensors. Whether or not features like regenerative braking, riding modes and Bluetooth connectivity are available is unclear at the moment.
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/download (2).jpg" alt="Black">
                    <div class="content">
                        <h3>Black</h3>
                ...
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/download (1).jpg" alt="Blue">
                    <div class="content">
                        <h3>Blue</h3>
                    </div>
                </div> -->
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/download (6).jpg" alt="Red">
                    <div class="content">
                        <h3>Red</h3>
                    </div>
                </div>                 -->
                <div class="swiper-slide box">
                    <img src="../image/Bike/Joy e-bike Thunderbolt/download.jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>                
...
<section class="VIDEO"  id="VIDEO">
    ...
    <br> 
<br> <strong>For More Information : </strong> <a href="https://www.joyebike.com/product/thunderbolt/" target="_blank" >Click Here </a>

</section>

<section class="Test_drive" id="Test_drive">
    <a href="https://www.joyebike.com/product/thunderbolt/" class="btn" target="_blank">Book a Test Ride</a>
</section>
