...
<body>
    ...
    <section class="home" id="home">
        ...
        <h3>Komaki Ranger</h3>
        <img  src="../image/Bike/Komaki Ranger/download (9).jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Komaki Ranger/download (6).jpg" alt="Komaki Ranger">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Komaki Ranger/download (7).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Komaki Ranger/download (8).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Komaki Ranger/download (2).jpg" alt="Super Mileage">
                    <div class="content">
                        <h3>Super Mileage</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Komaki Ranger/download (3).jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Komaki Ranger/download (11).jpg" alt="Body">
                    <div class="content">
                        <h3>Body</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 1.68 Lakh onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 250 Kms &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- 5-6 hrs &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 1-2 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 4 kwh &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <!-- <i class="fa-solid fa-car-side"></i> <strong> Body Type</strong> :- SUV &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
        <i class="fa-solid fa-bicycle"></i> <strong>Max speed</strong> :- 200 kmph
     </div>
    </section>
        ...
        <div style="overflow-x:auto">
            <table style="width:100%">
                ...
                <tr>
                    <td>Ranger STD</td>
                    <td>₹ 1.68 Lakh</td>
                    <td>Automatic, Combi Brake System, BLDC</td>
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Komaki has launched India’s first electric cruiser bike, the Ranger. It boasts a handful of features, a claimed 200km range, and a classic cruiser-style design.
            <span id="dots">...</span><span id="more">
        
         <br><br>
         The Komaki Ranger’s design seems inspired by big ICE cruiser bikes, featuring low seats, wide tyres, and swept-back handlebars.


         Keeping range anxiety in mind, the company has equipped the Ranger with a 4kWh battery, claimed to offer around 200km on a single charge. The battery comes mated to a 4kW motor.
         <br><br>
         As for features, you get cruise control, a Bluetooth-equipped music system, gear modes, LED lights, storage boxes, and disc brakes with CBS.


         The Komaki Ranger rolls on alloy wheels at both ends, sprung on a telescopic fork and dual shock absorbers.
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Bike/Komaki Ranger/download (7).jpg" alt="Jet Black">
                    <div class="content">
                        <h3>Jet Black</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Komaki Ranger/download (13).jpg" alt="Deep Blue">
                    <div class="content">
                        <h3>Deep Blue</h3>
                    </div>
                </div>
                <div class="swiper-slide box">
                    <img src="../image/Bike/Komaki Ranger/download (12).jpg" alt="Garnet Red">
                    <div class="content">
                        <h3>Garnet Red</h3>
                    </div>
                </div>                
                <!-- <div class="swiper-slide box">
                    <img src="../image/Bike/Komaki Ranger/download.jpg" alt="Yellow">
                    <div class="content">
                        <h3>Yellow</h3>
                    </div>
                </div>                 -->
...
<section class="VIDEO"  id="VIDEO">
    ...
    <br> 
<br> <strong>For More Information : </strong> <a href="https://komaki.in/ranger/" target="_blank" >Click Here </a>
