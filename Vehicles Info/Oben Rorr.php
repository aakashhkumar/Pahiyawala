...
<body>
    ...
    <section class="home" id="home">
        ...
        <h3>Oben Rorr</h3>
        <img  src="../image/Bike/Oben Rorr/Obenrorrbackdrop.jpg" class="responsive" alt="">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Oben Rorr/download (6).jpg" alt="Oben Rorr">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Oben Rorr/download (7).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Oben Rorr/download (5).jpg" alt="">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Oben Rorr/download (9).jpg" alt="">
                    <div class="content">
                        <h3>Rear View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Oben Rorr/download (1).jpg" alt="Super Mileage">
                    <div class="content">
                        <h3>Super Mileage</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Oben Rorr/download (8).jpg" alt="Amazing Wheels">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Bike/Oben Rorr/download (3).jpg" alt="Body">
                    <div class="content">
                        <h3>Body</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 1.03 Lakh onwards &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 200 Kms &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :- 2 hrs &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 1-2 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery Capacity</strong> :- 4.4kwh &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
    ...
    <section class="Summary" id="Summary">
        ...
        Rorr battery takes 2 Hours to get charged.

        The Oben Rorr is available only in one variant and is priced at Rs 99,999, ex-showroom Maharashtra, including FAME II and state subsidies.
         <br><br>
         The Oben Rorr features a fully digital instrument cluster with smartphone connectivity. Additionally, it comes with predictive maintenance, ride details, battery status, geo-fencing, geo-tagging, charging station locator, on-demand service, and roadside assistance. 
        </span>
        </p>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide box">
                    <img src="../image/Bike/Oben Rorr/Magnetic Black.png" alt="Magnetic Black">
                    <div class="content">
                        <h3>Magnetic Black</h3>
                        
                    </div>
                </div>
               
                <div class="swiper-slide box">
                    <img src="../image/Bike/Oben Rorr/Electric Red.png" alt="Red">
                    <div class="content">
                        <h3>Electric Red</h3>
                    </div>
                </div>                
                <div class="swiper-slide box">
                    <img src="../image/Bike/Oben Rorr/Voltaic Yellow.png" alt="Yellow">
                    <div class="content">
                        <h3>Volatic Yellow</h3>
                    </div>
                </div>                
...
<section class="VIDEO"  id="VIDEO">
     ...
     <iframe width="560" height="315" src="https://www.youtube.com/embed/GzwxP0blZr4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>  &emsp;   <iframe width="560" height="315" src="https://www.youtube.com/embed/7hrigocQh38" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> -->
    <br> 
<br> <strong>For More Information : </strong> <a href="https://www.obenev.com/rorr/" target="_blank" >Click Here </a>

</section>

<section class="Test_drive" id="Test_drive">
    <a href="https://booking.obenev.com/" class="btn" target="_blank">Book a Test Ride</a>
</section>
