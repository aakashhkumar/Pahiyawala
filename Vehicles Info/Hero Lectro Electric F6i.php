...
<body>
    ...
    <section class="home" id="home">
        ...
        <h3>Hero Lectro F6i</h3>
        <img  src="../image/Cycles/Hero Lectro Electric F6i/logo.jpg" class="responsive" alt="">
...
<section class="icons-container">
        ...
        <div class="swiper vehicles-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro Electric F6i/front.png" alt="TATA NEXON EV">
                    <div class="content">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro Electric F6i/lhs.png" alt="">
                    <div class="content">
                        <h3>Side View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro Electric F6i/rhs.png" alt="">
                    <div class="content">
                        <h3>RHS View</h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro Electric F6i/back.png" alt="">
                    <div class="content">
                        <h3>Back View</h3>
    ...
    <section class="Specifications " id="Specifications">
     ...
     <div style="font-size: 1.2vw;">
        <i class="fa-solid fa-indian-rupee-sign"></i><strong> Price</strong> :- ₹ 54,999 &emsp;&emsp;&emsp;&emsp;
        ...
        <i class="fa-solid fa-gears"></i><strong>Motor</strong> :- BLDC 36V/250W, Rear Hub Motor <br>
        <i class="fa-solid fa-road"></i><strong> Driving Range</strong> :- 437 km &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
        <i class="fa-solid fa-battery-three-quarters"></i><strong> Charging Time </strong> :-6 hrs &nbsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;
        <i class="fa-solid fa-couch"></i><strong> Seating Capacity</strong> :- 2 People <br>
        <i class="fa-solid fa-car-battery"></i> <strong> Battery </strong> :- Detachable Li-Ion 36 V,11.6Ah &nbsp;&emsp;&emsp;&emsp;
    ...
    <section class="Summary" id="Summary">
        ...
        <p>Hero Lectro Electric F6i is a electric electric bike available at a price of Rs. 49,000 in India. It is available in only one variant and 2 colours. F6i goes 60km in a single charge and takes 5 - 6 hours for a full charge. The Hero Lectro Electric F6i gets disc brakes in the front. The Hero Lectro Electric F6i weighs 70 kg.
    ...
    <section style="text-align: center;" id="Brochure">
        <a href="https://www.scribd.com/document/525399668/New-Lectro-C5-27-5-Single-Speed-Electric-Cycle-Hero-Lectro#" class="btn" target="_blank">Click Here!! For Brochure</a>
    </section>
    ...
    <section class="featured" id="featured">
        ...
        <div class="swiper featured-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro Electric F6i/pic1.jpg" alt="Daytona Grey">
                    <div class="content">
                        <h3></h3>
                    </div>
                </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro Electric F6i/pic2.jpg" alt="Pristine White">
                    <div class="content">
                        <h3></h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro Electric F6i/pic3.jpg" alt="Intensi Teal">
                    <div class="content">
                        <h3></h3>
                ...
                <div class="swiper-slide box">
                    <img src="../image/Cycles/Hero Lectro Electric F6i/pic4.png" alt="Starlight">
                    <div class="content">
                        <h3></h3>
                        <!-- <a href="#" class="btn">check out</a> -->
                    </div>
...
<section class="VIDEO"  id="VIDEO">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/hYI7dICUIdA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

    <iframe width="560" height="315" src="https://www.youtube.com/embed/NGhxsz29k2U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
     <br>
